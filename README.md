...
You can customize several default configurations in _config.py_.
...
🚨📢 Start by opening _config.py_ and set `DEFAULT_ROOT_DIR` to your go-to folder. That way, you won’t have to pass in the directory every time or place its files in the same search directory. 📢🚨
...
** There are more available model shortcuts listed in _config.py_.
